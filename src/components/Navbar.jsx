  ...
  return (
    ...
    >
      ...
      <div className='flex items-center gap-3'>
        ...
        <span className='text-large hidden md:block font-semibold text-white'>
      ...
      <AnimatePresence>
          {showcredits && (         
            <motion.div
                ...
                className='absolute -right-12 mt-4 w-64 rounded-2xl bg-black/90 backdrop-blur-xl border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.7)] p-4 text-white'>
       ...
       <motion.div
            ...
            <span className='text-lg'>{userData?.name?.[0]?.toUpperCase()}</span>          
      </motion.div>
           ...
           {showprofile && (          
              <motion.div
                ...
                className='absolute right-0 mt-4 w-64 rounded-2xl bg-black/90 backdrop-blur-xl border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.7)] p-4 text-white'>         
                    ...
                    <MenueItem text="History" onClick={()=>{setShowProfile(false);navigate("/history")}}/>
                    <div className='h-px bg-white/10 mx-3'/>
                    <MenueItem text="sign out" red  onClick={handleSignOut}/>
               </motion.div>     )}    
      </AnimatePresence>
       </div>
     ...
     function MenueItem ({onClick, text , red}){
            return(
              <div 
              onClick={onClick}
              className={`
                w-full text-left px-5 py-3 text-sm transition-colors rounded-2xl
                ${
                red
