    ...
    <div className='min-h-screen bg-linear-to-br from-gray-100 to-gray-200 px-6 py-8'>
     <motion.header 
      ...
      className='mb-10 rounded-2xl 
        bg-black/80 backdrop-blur-xl border border-white/10 px-8 py-6 shadow-[0_20px_45px_rgba(0,0,0,0.6)] flex md:items-center justify-between gap-4 flex-col md:flex-row'
        > 
        ...
        <div  
         className='flex items-center gap-4 flex-wrap'>
           ...
           <button onClick={()=>{navigate("/history")}}
            className='text-sm font-medium flex items-center gap-2 px-4 py-3 rounded-full bg-white/10 border border-white/20 text-white hover:bg-white/20 transition'>
           📚Your Notes
           ...
           )}
      {
        !result &&
         ...
         bg-white/60 backdrop-blur-lg border border-dashed border-gray-300 text-gray-500 shadow-inner'>
