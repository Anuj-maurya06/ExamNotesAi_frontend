...
function PricingCard({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -4 }}
      className={`relative cursor-pointer rounded-xl p-6 bg-white border transition transform
        ${isSelected ? 'scale-105 shadow-lg border-black' : popular ? 'border-indigo-500' : 'border-gray-200'}`}
    >
      {popular && !isSelected && (
